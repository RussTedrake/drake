...
#pragma GCC diagnostic pop
...

  {
    ...
    hybrid  // BR
        ...
        .def("num_modes", &Class::num_modes, cls_doc.num_modes.doc)
        .def(
        ...
        .def("AddModeWithInelasticImpact", &Class::AddModeWithInelasticImpact,
            ...
            py::arg("num_time_samples"), py::arg("sticking_contact"),
            cls_doc.AddModeWithInelasticImpact.doc)
        .def("mode", &Class::mode, py_rvp::reference_internal, py::arg("i"),
            cls_doc.mode.doc)
