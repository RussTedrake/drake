...
load("@drake//tools/workspace/models_robotlocomotion:repository.bzl", "models_robotlocomotion_repository")  # noqa
...
def add_default_repositories(excludes = [], mirrors = DEFAULT_MIRRORS):
    ...
    if "models_robotlocomotion" not in excludes:
        models_robotlocomotion_repository(name = "models_robotlocomotion", mirrors = mirrors)  # noqa
